// https://css-tricks.com/form-validation-part-1-constraint-validation-html/ + https://codepen.io/cferdinandi/pen/ZyLzQV with a couple of tweaks
...
window.displayMailChimpStatus = function (data) {
    ...
    if (data.result === 'error') {
        ...
        mcStatus.classList.add('danger');
        return;
    }

    // Otherwise, add success class
    mcStatus.classList.remove('danger');
